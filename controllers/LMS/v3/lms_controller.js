...
module.exports = {
  ...
  getTotalLeadData: async (req, res) => {
    ...
    SELECT
        ...
        COUNT(CASE WHEN l.LeadStatus IN (11,18,19,20,21,22,23,24,31,43,110,135,149,150) THEN 1 END) AS followUp,
  ...
  getPaymentSummaryData: async (req, res) => {
    try {
      ...
      let sqlqueryPaymentLeads = `
            ...
            RIGHT JOIN \`Payment_Details\` AS P ON L.LeadId = P.LeadId
